...
function getDestinationMeta(pathname: string): DestinationMeta {
  ...
  if (p.includes('/swimming')) {
    return {
      ...
      action: {
        en: 'Calibrating Olympic hydro lanes and water dynamics...',
  ...
  if (p.includes('/football')) {
    return {
      badge: { en: 'FOOTBALL ACADEMY', ar: 'أكاديمية كرة القدم' },
  ...
  if (p.includes('/store/cart') || p.includes('/store/checkout')) {
    return {
      badge: { en: 'OLYMPIC CHECKOUT', ar: 'الدفع الآمن' },
  ...
  if (p.startsWith('/store')) {
    return {
      ...
      title: { en: 'United Olympic Store', ar: 'متجر يونايتد أوليمبيكس الرسمي' },
      action: {
        en: 'Curating certified apparel, performance gear and equipment...',
        ar: 'جاري تجهيز كتالوج الأزياء والمعدات الرياضية المعتمدة...',
      },
      icon: ShoppingBag,
    };
  }
  ...
  if (p.includes('/programs')) {
    return {
      ...
      title: { en: 'Olympic Training Pathways', ar: 'المسارات والبرامج التدريبية' },
      action: {
  ...
  if (p.includes('/coaches')) {
    return {
      ...
      title: { en: 'Elite Olympic Coaches', ar: 'كادر المدربين الأولمبي المعتمد' },
      action: {
        en: 'Retrieving certified master trainers and achievement records...',
        ar: 'جاري استرجاع سجلات المدربين المعتمدين وخبراتهم...',
      },
      icon: Users,
    };
  }
  ...
  if (p.includes('/about')) {
    return {
      ...
      action: {
        en: 'Loading academy philosophy, foundational standards and vision...',
        ar: 'جاري تحميل فلسفة الأكاديمية ومعاييرها الأولمبية...',
      },
      icon: Sparkles,
    };
  }
  ...
  // Default Home
  return {
    badge: { en: 'OLYMPIC CAMPUS', ar: 'المنصة الأولمبية' },
    title: { en: 'United Olympics Sports', ar: 'يونايتد أوليمبيكس سبورت' },
    action: {
      en: 'Opening the Olympic campus and sports experience...',
      ar: 'جاري فتح المنصة الأولمبية والتجربة الرياضية...',
    },
    icon: Trophy,
  };
}
